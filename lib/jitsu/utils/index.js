...
utils.createPackage = function (dir, callback) {
  var help = [
    ...
    'We need a couple fields like name and subdomain to continue',
    '',
    'Press ^C at any time to quit.'
  ];
  
  winston.warn('There isn\'t a valid package.json file in ' + dir.magenta);
  winston.warn('Creating package.json at ' + (dir + '/package.json').magenta);
...
utils.packageProperties = function (dir) {
  return [
    ...
    },
    {
      ...
      validator: /[\w|\-|\_]+/,
      help: [
        'In order to create an application we\'ll need a unique subdomain',
        'You\'re application will then become accessible at: http://yourdomain.nodejitsu.com'
      ]
    },
    {
      name: 'scripts.start',
