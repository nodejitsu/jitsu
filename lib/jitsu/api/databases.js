...
//
Databases.prototype.create = function (databaseName, callback) {
  this._request('POST', ['databases', this.options.get('username'), databaseName], {type:'couch'}, callback, function (res, result) {
