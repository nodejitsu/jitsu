...
config.list = function (callback) {
  ...
  var display = [
    'Hello '.cyan + jitsu.config.username.green + ' here is your ' + jitsu.config.filepath().magenta + ' file:',
    '',
    'If you\'d like to change a property try:'.cyan,
    '',
    '  jitsu config set <key> <value>'.cyan,
    '',
    'or...'.cyan,
    '',
    '  jitsu config help'.cyan,
    ''
  ];
