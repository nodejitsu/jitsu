...
var knockout = module.exports = function (callback) {
  ...
  winston.info('If you need a code, go to ' + 'http://nodeknockout.com/teams/mine'.grey);
  ...
  jitsu.prompt.get(['node knockout code'], function (err, result) {
    ...
    request({
      uri: 'http://nodeknockout.com/teams/' + encodeURIComponent(result['node knockout code']) + '/deploys?nop'
    },
    function (err, res, body) {
      ...
      winston.info('node knockout code'.grey + ' confirmed! Saving your code...');
