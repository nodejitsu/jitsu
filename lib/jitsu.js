...
jitsu.welcome = function () {
  ...
  if (minor >= 6) {
    winston.help('Your version of node.js ' + 'supports'.green + ' newer versions of jitsu.');
    winston.help('You can upgrade by running:');
    winston.help('');
    winston.help('>'.grey + ' npm install jitsu -g');
    winston.help('');
  }
  else {
    winston.help('In order to use the latest version of jitsu, you will need');
    winston.help('to install a newer version of `node.js`.');
    winston.help('');
    winston.help('Unless you are running legacy code, we recommend upgrading');
    winston.help('to ' + 'node v0.6.x'.cyan + '.');
    winston.help('');
    winston.help('If you require assistance, please contact ' + 'support@nodejitsu.com'.cyan + '.');
    winston.help('');
  }
};
