...
jitsu.welcome = function () {
  ...
  winston.warn('This version of jitsu is ' + 'deprecated'.bold);
  ...
  if (minor > 6) {
    winston.warn('New version of jitsu can be used with this version of node.js');
    winston.warn('You can upgrade by running `npm -g install jitsu`');
  }
  else {
    winston.warn('This version of node.js is old. Please upgrade to latest stable version.');
  }
};
