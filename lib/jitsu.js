...
jitsu.setup = function (callback) { 
  ...
  jitsu.config.set('remoteUri', jitsu.config.get('remoteUri'));
  jitsu.users = new jitsu.api.Users(jitsu.config.store.store);
  jitsu.apps = new jitsu.api.Apps(jitsu.config.store.store);
  jitsu.snapshots = new jitsu.api.Snapshots(jitsu.config.store.store);
  jitsu.databases = new jitsu.api.Databases(jitsu.config.store.store);
  jitsu.logs = new jitsu.api.Logs(jitsu.config.store.store);
  jitsu.started = true;
